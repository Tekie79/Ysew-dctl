...
6. Pass all controls explicitly into helper functions. Keep DCTL UI identifiers, types, option ordering, and declaration ordering stable after publication; update the UI contract and document any breaking change.
