...
REQUIRED=[
    Path('dist/YSEW_Film_Lab_M7_A5.dctl'),
    Path('README.md'),
...
def validate_inputs():
    ...
    if (ROOT/'dist/YSEW_Film_Lab_M7_A5.dctl').read_bytes()!=SOURCE.read_bytes():
        raise ValueError('M7 A5 alias must be byte-identical to canonical source')
