...
| M4 | Separate halation, bloom, lens glow and veiling glare; multi-radius spectral-weighted spatial kernels; quality/performance tiers and stage-contribution views | Implemented as opt-in two-ring texture sampling with quality tiers and contribution views; comprehensive Resolve/Metal visual/performance acceptance deferred |
